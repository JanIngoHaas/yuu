...
fn test_comparison_chain() {
    ...
    let output = run_executable_with_output(&executable, &[])
        .expect("Failed to run comparison chain test");
...
fn test_mixed_unary_binary_operators() {
    ...
    let output = run_executable_with_output(&executable, &[])
        .expect("Failed to run mixed operators test");
...
fn test_deep_expression_nesting() {
    ...
    let output = run_executable_with_output(&executable, &[])
        .expect("Failed to run deep nesting test");
...
fn test_complex_boolean_expression() {
    ...
    let output = run_executable_with_output(&executable, &[])
        .expect("Failed to run complex boolean test");
...
fn test_precedence_with_all_operators() {
    ...
    let output = run_executable_with_output(&executable, &[])
        .expect("Failed to run all operators test");
