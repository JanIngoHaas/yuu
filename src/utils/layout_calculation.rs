...
pub fn calc_i64_size() -> usize { 8 }
pub fn calc_i64_alignment(_platform: TargetPlatform) -> usize { 8 }

pub fn calc_f64_size() -> usize { 8 }
pub fn calc_f64_alignment(_platform: TargetPlatform) -> usize { 8 }

pub fn calc_f32_size() -> usize { 4 }
pub fn calc_f32_alignment(_platform: TargetPlatform) -> usize { 4 }

pub fn calc_bool_size() -> usize { 1 }
pub fn calc_bool_alignment(_platform: TargetPlatform) -> usize { 1 }

pub fn calc_pointer_size(_platform: TargetPlatform) -> usize { 8 } // WASM Memory64 uses 64-bit addresses
pub fn calc_pointer_alignment(_platform: TargetPlatform) -> usize { 8 }
...
pub fn calc_i64_size_current() -> usize { calc_i64_size() }
pub fn calc_i64_alignment_current() -> usize { calc_i64_alignment(TargetPlatform::current()) }

pub fn calc_f64_size_current() -> usize { calc_f64_size() }
pub fn calc_f64_alignment_current() -> usize { calc_f64_alignment(TargetPlatform::current()) }

pub fn calc_f32_size_current() -> usize { calc_f32_size() }
pub fn calc_f32_alignment_current() -> usize { calc_f32_alignment(TargetPlatform::current()) }

pub fn calc_bool_size_current() -> usize { calc_bool_size() }
pub fn calc_bool_alignment_current() -> usize { calc_bool_alignment(TargetPlatform::current()) }

pub fn calc_pointer_size_current() -> usize { calc_pointer_size(TargetPlatform::current()) }
pub fn calc_pointer_alignment_current() -> usize { calc_pointer_alignment(TargetPlatform::current()) }
